  ...
  <el-row type="flex" justify="center">
    <el-col :span="12">
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('courseInfo')">立即添加</el-button>
    ...
    return {
      ...
      rules: {
        courseCode: [
          ...
          { min: 9, max: 9, message: "请输入9位课程号", trigger: "blur" }
        ],
        courseName: [
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          //   });
          postRequest("/mock/addCourse", this.courseInfo).then(response => {
            this.$notify({
              title: "成功",
